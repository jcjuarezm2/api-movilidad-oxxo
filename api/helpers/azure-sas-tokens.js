// An HTTP trigger Azure Function that returns a SAS token for Azure Storage 
...
//        context.res = generateSasToken(context, 
//            req.body.container, 
//            req.body.blobName, 
...
function generateSasToken(container, blobName, permissions) {
    var connString = app_configuration.get('azure.sas.connection_string');
    ...
    var sasToken = blobService.generateSharedAccessSignature(container, 
        blobName, 
        sharedAccessPolicy);
...
module.exports.generateSasToken = generateSasToken;  
