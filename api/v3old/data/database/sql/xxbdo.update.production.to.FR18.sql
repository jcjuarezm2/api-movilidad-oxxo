...
DELETE FROM `xxbdo_configuracion` WHERE `modulo`="utensilios";
...
('558f0f16-fcad-404e-9526-007d252e8cbc', 'utensilios', 'num_maximo_utensilios_nuevos_permitidos_por_mes', '100000', 3, 1, 1, NULL, NULL, NOW(), NOW()),
('56433555-6e1e-4db5-b739-dc921218e39f', 'utensilios', 'fecha_inicio_checklist_utensilios', '2020-01-01', 6, 1, 1, NULL, NULL, NOW(), NOW()),
('88480b66-a38e-4905-a4c4-16e1c9c8bd85', 'utensilios', 'numero_meses_vista_inicial_tablet_checklist_utensilios', '6', 1, 1, 1, NULL, NULL, NOW(), NOW()),
('a5569549-4971-433c-be14-584382fd7b74', 'utensilios', 'categoria_utensilios_varios', 'b0860623-1b5b-42fc-9ad9-2445d200fd10', 5, 1, 1, NULL, NULL, NOW(), NOW()),
('ae5feba3-3dea-40d1-bd46-b9440c19464f', 'utensilios', 'num_maximo_de_folios_por_utensilio', '2', 4, 1, 1, NULL, NULL, NOW(), NOW()),
('c825a17f-a8a2-44df-b907-e90d3eeda3bc', 'utensilios', 'paleta_de_colores_hexadecimal', '#D50000,#C51162,#AA00FF,#6200EA,#304FFE,#2962FF,#0091EA,#00B8D4,#00BFA5,#00C853,#64DD17,#AEEA00,#FFD600,#FFAB00,#FF6D00,#DD2C00', 2, 1, 1, NULL, NULL, NOW(), NOW()),
('e309a17b-8021-4299-8760-6da12b965aa3', 'utensilios', 'numero_meses_vista_inicial_web_checklist_utensilios', '8', 1, 1, 1, NULL, NULL, NOW(), NOW()),
...
('009f1b13-2e06-4f12-9eb4-69bddc72be8f', '7cd81a27-7486-4392-bf1f-8468c13d6ec2', NULL, NULL, 'U', 'Tapete check out', 'Tapete check out', 'Utilizado por el cajero durante su estancia en caja', 1, 0, '607b22d7-92e1-495a-93e6-b0123931f097.png', '18634', 'ATL > Recursos humanos > Solicitud de tapete de check out', 1, NULL, NULL, NOW(), NOW()),
...
('12b1fa16-6e40-4098-ac11-47362e485bf3', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Tapete de checkout', 'Tapete de checkout\r\n(18634)', '', 23, 1, '', '18634', 'Módulo ATL> Recursos Humanos> Solicitudes de Habilitadores> Tapete de checkout', 1, NULL, NULL, NOW(), NOW()),
('187a6182-cee1-4af9-93fb-a27987282fab', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Señalización de Basura', 'Señalización de Basura\r\n(12758)', '', 18, 1, '30416b02-9a7a-41ad-be6c-a594f273093b.png', '12758', 'Módulo ATL> Mercadeo> Mercadeo> Señalización Institucional> Piezas sueltas o kit completo> Señalización de Basura', 1, NULL, NULL, NOW(), NOW()),
...
('2fa708ec-6a14-4d8d-92f4-f3c19e174a00', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Porta-etiquetas Góndola Central', 'Porta-etiquetas Góndola Central', '', 34, 1, '', '-', 'Módulo ATL> Mercadeo> Equipamiento>Porta-\r\netiquetas y con stock en plaza/Solicitud de manerales de cuarto frío> Porta-etiquetas Góndola Central', 1, NULL, NULL, NOW(), NOW()),
...
('959f4139-c646-49c5-8ea9-a65ece6fc97f', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Navaja de Seguridad', 'Navaja de Seguridad', '', 31, 1, '7131f49d-86a6-43cc-81b4-43d162cdf04a.png', '-', 'Kit In & Out Semestral> Navaja de Seguridad', 1, NULL, NULL, NOW(), NOW()),
('96a4b640-0135-4c9a-8dec-a72290739643', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Bomba para garrafón', 'Bomba para garrafón', '', 30, 1, '', '-', 'Módulo ATL> Recursos Humanos> Solicitudes de Habilitadores> Bomba para garrafón', 1, NULL, NULL, NOW(), NOW()),
...
('c7f96c9e-0466-40ec-aa38-f829ad1142fd', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Porta-etiquetas Cuarto Frio', 'Porta-etiquetas Cuarto Frio', '', 33, 1, '', '-', 'Módulo ATL> Mercadeo> Equipamiento>Porta-\r\netiquetas y con stock en plaza/Solicitud de manerales de cuarto frío> Porta-etiquetas Cuarto Frio', 1, NULL, NULL, NOW(), NOW()),
...
('cce2e8a0-beed-4e0a-9dbd-81f3c35eb793', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Porta Bolsas', 'Porta Bolsas', '', 16, 1, '', '-', 'Módulo ATL> Operaciones> Autorización, Seguimiento y Solicitudes en Tienda> Porta Bolsas', 1, NULL, NULL, NOW(), NOW()),
...
('f8c82740-220e-44c7-beff-f4852da616ed', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Espátula quita-chicles', 'Espátula quita-chicles', '', 27, 1, '8f4f2570-0f81-440b-a021-49883ddd4bcd.png', '-', 'Kit In & Out Semestral> Espátula quita-chicles', 1, NULL, NULL, NOW(), NOW()),
('fed65468-e2bf-48ac-8ae9-ec3d4f119aba', '0b713f50-055a-4b10-ae40-8239c8426253', NULL, NULL, 'U', 'Cucharon para máquina de hielo', 'Cucharon para máquina de hielo\r\n(10275)', '', 21, 1, '6a25b91f-d0b8-4157-a532-e5f402bb17e1.png', '10275', 'Módulo ATL> Mercadeo> Equipamiento-Solicitud de cucharon para hielo> Cucharon para máquina de hielo', 1, NULL, NULL, NOW(), NOW());
...
('0b713f50-055a-4b10-ae40-8239c8426253', 'LIMPIEZA', 'Utensilios de Limpieza', 'U', 2, 1, 1, NULL, NULL, '2019-11-07 15:33:08', '2019-11-07 15:33:08'),
('55451e2c-b9c1-418c-a444-3392b422aaf7', 'COMIDA RÁPIDA', 'Utensilios de comida rápida', 'U', 1, 1, 1, NULL, NULL, '2019-11-07 15:33:08', '2019-11-07 15:33:08'),
('7cd81a27-7486-4392-bf1f-8468c13d6ec2', 'HABILITADORES', 'Utensilios habilitadores', 'U', 3, 1, 1, NULL, NULL, '2019-11-07 15:33:08', '2019-11-07 15:33:08'),
('ac29e1a0-e0a8-4495-b6eb-806a77a36f30', 'PAPELERIA', 'Utensilios de Papelería', 'U', 4, 1, 1, NULL, NULL, '2019-11-07 15:33:08', '2019-11-07 15:33:08'),
('b0860623-1b5b-42fc-9ad9-2445d200fd10', 'VARIOS', 'Utensilios no catalogados', 'V', 1000, 1, 1, NULL, NULL, '2019-11-07 15:33:08', '2019-11-07 15:33:08');
...
ALTER TABLE `xxbdo_respuestas_utensilios`
  ...
  ADD KEY `XXBDO_RESPTS_UTNSLS_FOLIO_INDX` (`folio`);
...
ALTER TABLE `xxbdo_utensilios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `XXBDO_UTENSILIOS_CATEGORIAS_ID_INDX` (`xxbdo_utensilios_categorias_id`),
  ADD KEY `XXBDO_UTNSLS_PLAZA_TIENDA_INDX` (`cr_plaza`,`cr_tienda`),
