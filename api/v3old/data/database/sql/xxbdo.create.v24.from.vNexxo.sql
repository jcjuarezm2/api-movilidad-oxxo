...
('b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'Estandares Operativos Version 24', 'Versión 24', 'Estandares Operativos Versión 24', 0, '2019-11-01', NULL, 1, NULL, NULL, NOW(), NOW());

-- insertar registro de checklist vNexxo = c98336f8-cf56-4a30-909a-42b592928219 : 
...
VALUES ('c98336f8-cf56-4a30-909a-42b592928219', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'Estándares Operativos Versión 24', 'Estándares Operativos Versión 24', 'BITACORA v24', 'INDICADORES v24', '2019-11-01', NULL, 0, 1, NULL, NULL, NOW(), NOW());
...
('ccd17e86-82c5-41ff-8922-d7a35d1979ad', '1b7ea94a-9914-4bb3-b7d6-d8e8b1861777', '10f81bf8-ff1b-415e-8fda-c420f1dbf914', 0, 2, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
('a48f63e6-6e94-4052-adfc-971d35d96d0f', '1b7ea94a-9914-4bb3-b7d6-d8e8b1861777', '63dbc878-8105-40d6-8cb9-2acfddce1640', 0, 3, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
...
('abe9cc02-abf4-4b64-a6f5-09b989fcafad', '018e59f2-b950-4340-b8dc-6cee7171e975', '152ce08f-b465-44f8-9560-32e09a67865f', 0, 2, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
('e4e9c493-3bb5-4f0e-9ce2-5de9ee98b9af', '018e59f2-b950-4340-b8dc-6cee7171e975', '942567f1-9891-4cf1-bdb9-eafb8339f0e3', 0, 3, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
('146c9090-3820-4df7-836c-4498c9c23621', '018e59f2-b950-4340-b8dc-6cee7171e975', '6bcfaf2f-40a7-44bf-b554-d07c644196b9', 0, 4, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
('516f3630-3dca-4f72-b967-973181766d38', '018e59f2-b950-4340-b8dc-6cee7171e975', 'fc921750-4a86-4c65-a663-b3d9ac0fa155', 0, 5, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
('6d375a88-e693-4af5-9f96-798ae4fb0f04', '018e59f2-b950-4340-b8dc-6cee7171e975', '88622a43-736e-4bdc-87d2-08b0da8ad325', 0, 6, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
('48f07de9-fe2d-47ea-bcc3-ae369bdfe5ac', '018e59f2-b950-4340-b8dc-6cee7171e975', 'b1b19ac7-b4b5-4d82-bd95-9d674f24de3d', 0, 7, '1,2,3,4,5,6,7', 1, NULL, NULL, NOW(), NOW()),
...
-- EL OBJETIVO ES CREAR OTRA VERSION NO DEFAULT Y ASIGNARLA A 1 O MAS TIENDAS 
-- PARA VERIFICAR QUE EL API SOPORTA ESTE CASO
...
-- deshabilitar todos los checklists para la tienda especifica
-- update `xxbdo_checklists_tiendas` set es_default='0' WHERE `cr_plaza`='10MDA' AND `cr_tienda`='50JAI' ;

-- marcar como default checklist nuevo en BDO API v2 para tienda de prueba:
-- INSERT INTO `xxbdo_checklists_tiendas` SELECT 'c98336f8-cf56-4a30-909a-42b592928219' AS cid, `cr_plaza`, `cr_tienda`, '1' AS `es_default`, '1' AS `activo`, 'adrian.zenteno.ext@oxxo.com' AS `usuario`, NULL AS  `ip_address`, NOW(), NOW() FROM `xxbdo_checklists_tiendas` WHERE `xxbdo_checklists_id`='3e50f58c-8634-41ce-93b5-c8bebb8bce46';

-- marcar como default checklist nuevo en BDO API v3 para tienda de prueba:
INSERT INTO `xxbdo_checklists_tiendas` SELECT 'c98336f8-cf56-4a30-909a-42b592928219' AS cid, `cr_plaza`, `cr_tienda`, 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'Estándares Operativos Versión 24', 'Estándares Operativos Versión 24', 'BITACORA v24', 'INDICADORES v24', '2019-11-01', NULL, '1' AS `es_default`, '1' AS `activo`, 'adrian.zenteno.ext@oxxo.com' AS `usuario`, NULL AS  `ip_address`, NOW(), NOW() FROM `xxbdo_checklists_tiendas` WHERE `xxbdo_checklists_id`='3e50f58c-8634-41ce-93b5-c8bebb8bce46'  AND cr_plaza='10MDA' AND cr_tienda='50JAI';
...
-- ---------------------------------------------
-- -- Ingreso - Control
('142cb69b-c96d-41c2-a264-004355d340f5', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Conteos', 'Conteos', 'S', NULL, 'int', '0', 1, NULL, NULL, NOW(), NOW()),
('0b9037f6-beb1-443f-a563-ecf09e6dd0da', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Cobertura', 'Cobertura (Indicador de tipo porcentaje)', 'S', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Gente - Manejo de Gente
('b71aa545-2a1f-40d6-aa97-7360b314511a', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Vector Gente', 'Vector Gente', 'S', NULL, 'int', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Ejecución - Comida Rápida
('fa2177be-44f1-4a5b-be4a-e8656e1cf1e5', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Exhibición Real Americano', 'Exhibición Real Americano (Indicador de tipo porcentaje)', 'S', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
('1e0199dc-a190-4e5a-830f-f0a25d43ab67', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Exhibición Real Roller', 'Exhibición Real Roller (Indicador de tipo Porcentaje)', 'S', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
('d6e40fc0-1221-4900-a98e-b554bf7e6842', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Veracidad de Inventarios', 'Veracidad de Inventarios', 'S', NULL, 'int', '0', 1, NULL, NULL, NOW(), NOW()),
('44f442b5-7ec4-4e38-a7a5-fc4473f96081', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, '% Cumplimiento a devoluciones diarias', 'Porcentaje de cumplimiento a devoluciones diarias (Indicador de tipo Porcentaje)', 'S', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Cliente - Venta Sugerida
('3495b774-00de-4a6b-849b-a1a4bf74c465', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Venta sugerida', 'Venta sugerida (Indicador de tipo monetario)', 'S', NULL, 'money', '0.00', 1, NULL, NULL, NOW(), NOW()),
('1a5a2c1c-205e-45be-8376-69647b695fd5', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Usuarios activos', 'Usuarios activos', 'S', NULL, 'int', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Cliente - Ambientación, Seguridad
('162647c5-64be-4bc6-af31-0b1ade168623', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Ev. 5S + 1', 'Ev. 5S + 1', 'S', NULL, 'int', '0', 1, NULL, NULL, NOW(), NOW()),
-- ---------------------------------------------
-- Indicadores Mensuales de Estándares Diarios:
-- ---------------------------------------------
-- -- Servicio - Imagen y comportamiento
('1bc6288f-a443-4154-a769-dfbb7fe0229a', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Ev. Operativa Sección Atención', 'Ev. Operativa Sección Atención', 'M', NULL, 'int', '0', 1, NULL, NULL, NOW(), NOW()),
...
('983c8c27-dfe2-46fd-a473-b5b8536b772b', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Ev. Operativa Sección Rapidez', 'Ev. Operativa Sección Rapidez (indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Ingreso - Control
...
('ec7ee9da-2a54-467e-b1a8-95dc65fd3179', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Scorecard preinventarios/ Entrega de Valores', 'Scorecard preinventarios/ Entrega de Valores (Indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
...
-- -- Gente - Manejo de Gente
('89da2f27-9167-457d-9b38-fa108f3af824', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Rotación', 'Rotación', 'M', NULL, 'int', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Ejecución - Limpieza
('349162f9-cf00-49dd-8a87-c5479c7d04e1', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Ev. Operativa Sección Limpieza', 'Ev. Operativa Sección Limpieza (Indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Ejecución - Exhibición
('9b33a063-283b-4cb5-8804-4642a935dafe', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Planogramas (Charola/Mueble)', 'Planogramas (Charola/Mueble) (Indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
('00e0692d-9c0e-41e2-970b-37053c451efb', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'MEP P.P.', 'MEP P.P. (Indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
...
('d507f027-fa52-47c8-a671-bf07e8f32ce4', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Ev. Operativa Sección Abasto', 'Ev. Operativa Sección Abasto (Indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Ejecución - Etiqueteo
('d1f41413-1911-4e96-8cad-c41fa8933ea0', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Scorecard Etiqueteo', 'Scorecard Etiqueteo (Indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
-- -- Ejecución - Comida Rápida
...
('801a5e8e-f97a-49de-9217-7414fce2c0ef', 'b794eae6-25c5-4e01-a69b-4a0fc29b259b', 'I', NULL, NULL, 'Ev. Operativa Puntos Cuarto Frío', 'Ev. Operativa Puntos Cuarto Frío (Indicador de tipo Porcentaje)', 'M', NULL, 'pct', '0', 1, NULL, NULL, NOW(), NOW()),
...
('39602934-f3dc-4a96-ab9b-4efb39af059e', '8d5ed8e7-2f5a-4924-9818-6900ca1db549', '142cb69b-c96d-41c2-a264-004355d340f5', 1, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 3 - Indicador Semanal: Cobertura
('50fb948b-0fd9-4bfa-9577-3106b1e12d7c', '8d5ed8e7-2f5a-4924-9818-6900ca1db549', '0b9037f6-beb1-443f-a563-ecf09e6dd0da', 2, 1, NULL, NULL, NOW(), NOW()),
...
('9e403359-c992-434e-8756-ac0756563ef9', '516f3630-3dca-4f72-b967-973181766d38', 'fa2177be-44f1-4a5b-be4a-e8656e1cf1e5', 4, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 10 - Indicador Semanal: Exhibición Real Roller
('f4ba7fc6-584b-4f14-98b6-7ffaf8c4ddbd', '516f3630-3dca-4f72-b967-973181766d38', '1e0199dc-a190-4e5a-830f-f0a25d43ab67', 5, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 10 - Indicador Semanal: Veracidad de Inventarios
('42de4c85-8ccc-47cb-842e-8a71a390b2b9', '516f3630-3dca-4f72-b967-973181766d38', 'd6e40fc0-1221-4900-a98e-b554bf7e6842', 6, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 10 - Indicador Semanal: % Cumplimiento a devoluciones diarias
('bbe8c7e4-a0e9-4ce6-b741-770034813759', '516f3630-3dca-4f72-b967-973181766d38', '44f442b5-7ec4-4e38-a7a5-fc4473f96081', 7, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 13 - Indicador Semanal: Venta Sugerida
('0207a836-d94b-4507-a9bd-62867e0f5c48', 'b4c03189-52ae-4e5e-adaf-dcad4b4e3197', '3495b774-00de-4a6b-849b-a1a4bf74c465', 8, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 13 - Indicador Semanal: Usuarios activos
('3348ca30-5a15-4d9c-9499-f2ee2fc74591', 'b4c03189-52ae-4e5e-adaf-dcad4b4e3197', '1a5a2c1c-205e-45be-8376-69647b695fd5', 9, 1, NULL, NULL, NOW(), NOW()),
...
('d8badeee-82ed-4576-9f27-c051f4fc5bbd', 'a48f63e6-6e94-4052-adfc-971d35d96d0f', '983c8c27-dfe2-46fd-a473-b5b8536b772b', 3, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 3 - Indicador Mensual: Resultado de Inventario
('6bb95421-e21a-4ba9-81d0-102dc8300bd3', '8d5ed8e7-2f5a-4924-9818-6900ca1db549', 'e7a0cc48-d265-4a8e-a2a7-f73c287c97e5', 4, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 3 - Indicador Mensual: Scorecard preinventarios
('5042aa87-128d-4804-91c8-7dcab513f3d1', '8d5ed8e7-2f5a-4924-9818-6900ca1db549', 'ec7ee9da-2a54-467e-b1a8-95dc65fd3179', 5, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 4 - Indicador Mensual: Equipos completos 
('df27bfb8-3628-4acf-bf95-c642714ffd89', '3a25a34e-c248-4a51-ba9e-a518c35d5b37', '70411ce6-2684-4ff4-9883-daef4b2fade6', 6, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 4 - Indicador Mensual: Equipos capacitados
('168d2b4a-f740-4283-8cf3-c9fc6a0496fd', '3a25a34e-c248-4a51-ba9e-a518c35d5b37', 'e3657741-22bb-4372-ad18-bee44f3092fb', 7, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 5 - Indicador Mensual: Rotación
('cebe044f-1b2f-4f06-a461-e65dd9439a22', '91ec9e8d-5e38-4d4d-ab7f-b661f0ee8edd', '89da2f27-9167-457d-9b38-fa108f3af824', 8, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 6 - Indicador Mensual: Ev. Operativa Sección Limpieza
('c95fc68c-7a92-4506-bc8e-0633994e76c4', '06a40226-a528-430f-86fd-08277a0dde4b', '349162f9-cf00-49dd-8a87-c5479c7d04e1', 9, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 7 - Indicador Mensual: Planogramas(Charola/Mueble)
('aa045ad9-16fa-4d16-a0ac-4917c45fda9c', 'abe9cc02-abf4-4b64-a6f5-09b989fcafad', '9b33a063-283b-4cb5-8804-4642a935dafe', 10, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 7 - Indicador Mensual: MEPP P.P.
('10b32ea7-9461-480d-abf7-3596167bf8e5', 'abe9cc02-abf4-4b64-a6f5-09b989fcafad', '00e0692d-9c0e-41e2-970b-37053c451efb', 11, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 8 - Indicador Mensual: Scorecard calidad de producto
('5f7d0fc7-29d3-438c-bd55-f828f46349f2', 'e4e9c493-3bb5-4f0e-9ce2-5de9ee98b9af', '64581739-9877-4d34-bdff-461b2105f689', 12, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 8 - Indicador Mensual: Ev. Operativa sección abasto
('a923f18d-af68-43c9-9cb1-5bf4d5f8a00c', 'e4e9c493-3bb5-4f0e-9ce2-5de9ee98b9af', 'd507f027-fa52-47c8-a671-bf07e8f32ce4', 13, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 9 - Indicador Mensual: Scorecard Etiqueteo
('9106de72-da01-4f6d-a5d5-c4ac82c875e7', '146c9090-3820-4df7-836c-4498c9c23621', 'd1f41413-1911-4e96-8cad-c41fa8933ea0', 14, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 10 - Indicador Mensual: Ev. Donas a Granel
('fcc3de6a-9383-43fa-9a95-5df6c5e6f5d2', '516f3630-3dca-4f72-b967-973181766d38', '6468d978-6073-4748-8012-eea033d8caa7', 15, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 11 - Indicador Mensual: Ev. Operativa Puntos Cuarto Frío
('b0e8b3d6-710c-4d35-a895-6eabf0ca8469', '6d375a88-e693-4af5-9f96-798ae4fb0f04', '801a5e8e-f97a-49de-9217-7414fce2c0ef', 16, 1, NULL, NULL, NOW(), NOW()),
-- -- Std # 12 - Indicador Mensual: MEP POP
('87d16200-105f-428c-8145-a8fb469fdc01', '48f07de9-fe2d-47ea-bcc3-ae369bdfe5ac', '6b5140d7-e653-4512-8096-99cc5edba209', 17, 1, NULL, NULL, NOW(), NOW());
