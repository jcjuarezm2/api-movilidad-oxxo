-- -----------------------------------------------------
-- Name: SP_XXBDO_CLONE_VERSION_BDO
-- Description: Borra tabla del reporte de captura de checklist por plaza.
-- Input: version_bdo_to_clone_id, end_date_version_bdo_to_expire, start_date_new_version_bdo, titulo, titulo_app, descripcion, titulo_indicadores_app
-- Output: None
-- 
-- Example: 
-- CALL SP_XXBDO_CLONE_VERSION_BDO("a74a4a3f-20e1-44e3-aadd-354647fd8210","2020-11-08","2020-11-09","Estándares Operativos Versión 26","Versión 26","Estándares Operativos BDO Versión 26","Indicadores v26");
-- -----------------------------------------------------

DELIMITER //
DROP PROCEDURE IF EXISTS `SP_XXBDO_CLONE_VERSION_BDO`//
...
BEGIN
    ...
    DECLARE _empty_string VARCHAR(36) DEFAULT "";
        ...
        BEGIN
            ...
            ELSE
                BEGIN
                    ...
                    DROP TABLE IF EXISTS `xxbdo_areas_temp`;
                    ...
                    `orden`, 
                    1 AS `activo`, 
                    _empty_string AS `usuario`, 
                    _empty_string AS `ip_address`, 
                    ...
                    DROP TABLE IF EXISTS `xxbdo_estandares_temp`;
                    ...
                    DROP TABLE IF EXISTS `xxbdo_indicadores_temp`;
                    ...
                    DROP TABLE IF EXISTS `xxbdo_areas_estandares_indicadores_temp`;
                    ...
                    _empty_string AS `xxbdo_areas_estandares_new_id`,
                    `xxbdo_indicadores_id` AS `prev_indicadores_id`, 
                    _empty_string AS `new_indicadores_id`,
                    `orden`, 
                    `activo`, 
                    _empty_string AS `usuario`, 
                    _empty_string AS `ip_address`, 
                    ...
                    DROP TABLE IF EXISTS `xxbdo_estandares_alertas_temp`;
                    ...
                    DROP TABLE IF EXISTS `xxbdo_evop_drivers_temp`;
                    ...
                    DROP TABLE IF EXISTS `xxbdo_evop_ponderacion_estandares_temp`;
                    ...
                    _empty_string AS `xxbdo_evop_drivers_new_id`, 
                    `ponderacion`, 
                    `es_activo`, 
                    `orden`, 
                    `activo`, 
                    ...
                    SET `xxbdo_evop_ponderacion_estandares_temp`.`xxbdo_evop_drivers_new_id` = `xxbdo_evop_drivers_temp`.`new_id` 
                    WHERE `xxbdo_evop_ponderacion_estandares_temp`.`xxbdo_evop_drivers_prev_id` = `xxbdo_evop_drivers_temp`.`prev_id`;
                    ...
                    DROP TABLE IF EXISTS `xxbdo_evop_promedios_drivers_temp`;
                    ...
                    `xxbdo_evop_drivers_temp` 
                    SET `xxbdo_evop_promedios_drivers_temp`.`xxbdo_evop_drivers_new_id` = `xxbdo_evop_drivers_temp`.`new_id` 
                    WHERE `xxbdo_evop_promedios_drivers_temp`.`xxbdo_evop_drivers_prev_id` = `xxbdo_evop_drivers_temp`.`prev_id`;
