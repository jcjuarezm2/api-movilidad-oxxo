...
USE `xxbdo_production_201910141050`;
...
CREATE TABLE IF NOT EXISTS `xxbdo_pendientes` (
  ...
  `fecha_modificacion` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `XXBDO_PENDIENTES_REG_POR_INDX` (`registrado_por` ASC) ,
  INDEX `XXBDO_PENDIENTES_RESP_INDX` (`responsable` ASC) ,
  CONSTRAINT `XXBDO_PENDIENTES_REG_POR_FK`
    FOREIGN KEY (`registrado_por`)
    REFERENCES `xxbdo_roles_en_tienda` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `XXBDO_PENDIENTES_RESP_FK`
